...
venue: "University of Mpumalanga,Mbombela Campus"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Cnr R40 and D725 Roads, Nelspruit, 1200"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Zine Sapula","TBC"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p id="collaborative_notes">
  We will use this <a href="http://pad.carpentries.org/YYYY-MM-DD-site"> collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
{% endif %}
